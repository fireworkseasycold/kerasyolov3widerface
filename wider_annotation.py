...
widerface数据集转成yolov3所需标签文本
"""
import os

val_bbx_file = 'F:/workfor/wider_face/wider_face_split/wider_face_val_bbx_gt.txt'
train_bbx_file = 'F:/workfor/wider_face/wider_face_split/wider_face_train_bbx_gt.txt'

val_data_folder = 'F:/workfor/wider_face/WIDER_val'
train_data_folder = 'F:/workfor/wider_face/WIDER_train'

out_file = 'F:/workfor/wider_face/WIDER_train.txt'
